...
InstancedGroup.prototype={
    ...
    init:function (texSrc,textNum,texFlipY){//纹理贴图资源路径，贴图中包含纹理的个数
        ...
        if(this.vertURL===undefined)this.vertURL="./crowd2/shader/vertexBone3.vert"  //this.haveSkeleton?"shader/vertexBone2.vert":"shader/vertex.vert";
        if(this.fragURL===undefined)this.fragURL="./crowd2/shader/fragment.frag"  //"shader/fragment.frag";
        ...
        if(this.haveSkeleton){
            ...
            loader.load("./crowd2/json/animationConfig.json", function(str){
            ...
            function updateAnimationData(index) {
                var loader = new THREE.XHRLoader(THREE.DefaultLoadingManager);
	            loader.load("../crowd2/json/animationData"+index+".json", function(str){//dataTexture
                ...
                // let worker = new Worker('./crowd2/js/animationLoadWorker.js');
                // worker.postMessage("../crowd2/json/animationData"+index+".json");
